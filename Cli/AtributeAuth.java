...
public class AtributeAuth {
    private static final String BASE_URL = "http://localhost:8080/AA";
...
//            System.out.println("1. Signup");
            if (jwtToken==null) System.out.println("1. Login");
                ...
                System.out.println("5. See all Hospital");
...
//        System.out.println(res);
    ...
    private static void addStaff(Scanner sc){
        ...
        obj.put("name",name);
        obj.put("pass",pass);
        String res=sendPost("/createHospital",obj.toString(),jwtToken);
        if (res.isEmpty()) {
    ...
    private static void seeAll(){
        String[] res=sendPost("/seeAllHospital","",jwtToken).split("}");
        for(String str:res)
    ...
    private static void deleteStaff(Scanner sc){
        ...
        String endpoint="/revokeHospital?id="+regNo;
